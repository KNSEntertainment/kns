						...
						<div className="space-y-4">
							{advertisements.map((ad) => (
								<div key={ad.id} className="relative w-full h-56 aspect-[3/2] rounded-lg overflow-hidden shadow-md">
									...
									<p className="absolute bottom-4 bg-black bg-opacity-50 text-white hover:text-red-100 text-lg md:text-xl px-6 hover:scale-105 cursor-pointer transition-all ease-in-out duration-100">{ad.title}</p>
								</div>
							))}
