						...
						{partners?.length > 0 ? (
							partners.map((partner) => (
								<TableRow key={partner.partner_name}>
									...
									<TableCell>
										<Image src={partner.partner_logo} width={200} height={200} alt={partner.partner_name} className="w-16 h-16 rounded-full object-cover" />
									</TableCell>
			...
			{openCreatePartnerModal && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
					<div className="bg-white p-6 rounded-lg shadow-lg w-96">
						...
						<PartnerForm handleClosePartnerModal={handleClosePartnerModal} />
					</div>
				</div>
			)}
		</>
