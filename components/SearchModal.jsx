	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-90 flex justify-center items-center z-50">
			...
			<form onSubmit={handleSearch} className="flex items-center gap-4">
				<input type="text" ref={searchInputRef} className="border-b border-red-700 bg-transparent p-8 text-6xl text-white focus:outline-none" placeholder="Search events..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} required />
