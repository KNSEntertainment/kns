		...
		<form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white px-12 pt-6 pb-8">
			...
			<div>
				...
				<div className="grid justify-items-end gap-2 mt-12">
					<button type="submit" disabled={submitting} className={`px-4 py-2 rounded ${submitting ? "bg-gray-400 cursor-not-allowed" : "bg-red-700 hover:bg-red-800"} text-white font-bold`}>
